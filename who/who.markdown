| Username | Name | Start | End | Coord? | Jobs | Link | Misc. |
| ---------|------|-------|-----|--------|------|------|------ |
| `adept` | Mark Mcullough | Fall 1995 | ??? | :white_check_mark: |  |  |  |
| `adt` | Aaron Teche | Spring 1997 | ??? | :white_check_mark: | Systems Programmer @ UW Biostatistics |  |  |
| `ajkunen` | Adam Kunen | ??? | ??? | :x: | Student |  |  |
| `alp` | Karen (Powers) Wooten | ??? | ??? | :white_check_mark: | Resident Physician @ University of Washington |  |  |
...
| `blue` | Chuck Spencer | ??? | Spring 1998 | :x: | Assoc Information Processing Consultant, UW Medical School |  |  |
| `bmartin` | Bret Martin | Fall 2001 | ??? | :white_check_mark: | Grad student @ UW-Madison |  |  |
| `bmuller` | Brenda Muller | ??? | ??? | :white_check_mark: |  |  |  |
| `cfarrell` | Chris Farrell | ??? | Spring 1994 | :x: | Principal Staff Engineer, Motorola, Inc. |  |  |
| `chaos` | Alan Desmet | Fall 1996 | ??? | :white_check_mark: | Programmer @ HTCondor |  |  |
...
| `hackbart` | Brian Hackbarth | ??? | ??? | :white_check_mark: | Masters Student, Purdue University |  |  |
| `hamblin` | Jeff Hamblin | Fall 1999 | (December 2000?) | :white_check_mark: | Microsoft |  |  |
| `hammer` | Matthew Hammer  | ??? | ??? | :white_check_mark: | PhD Student, Toyota Technical Institute |  |  |
